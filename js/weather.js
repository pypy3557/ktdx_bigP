...
// 날씨 api - 서울
var apiURI = "http://api.openweathermap.org/data/2.5/weather?q="+'busan'+"&appid="+"18d562be7f6caa48cfa832001710bdde";
$.ajax({
    url: apiURI,
    dataType: "json",
    type: "GET",
...
// // 날씨 api - 경기도
// var apiURI = "http://api.openweathermap.org/data/2.5/weather?q="+'Busan.KR'+"&appid="+"18d562be7f6caa48cfa832001710bdde";
// $.ajax({
//     url: apiURI,
//     dataType: "json",
//     type: "GET",
